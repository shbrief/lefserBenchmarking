...
LEfSeZellerDir <- "~/Projects/lefserBenchmarking/vignettes/zeller14/data"
```
...
lefserPlot(res)
ggsave("Figures/SupFig5A_CRC_lefser.png")
```
...
set.seed(1982)
# resAll <- lefserAllRanks(relativeAb(zeller14_tn), 
#                          groupCol = "study_condition", 
#                          blockCol = "age_category")
resAll <- lefserAllRanks(relativeAb(zeller14_tn), 
                         groupCol = "study_condition")
...
lefse_docker <- readr::read_tsv(
    file.path(LEfSeZellerDir, "zeller14/zeller14.res"),
...
ggsave("Figures/SupFig5B_CRC_LEfSe.png")
```
...
ggsave("Figures/SupFig5C_CRC_microbiomeMarker.png")
```
