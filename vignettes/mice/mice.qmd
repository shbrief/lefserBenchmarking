...
res <- lefser(relativeAb(mice_se), 
              ...
              lda.threshold = 2)
lefserPlot(res, title = "lefser")
ggsave("Figures/Fig1A_mice_lefser.png")
```
...
lefserPlot(lefse_docker_for_plot, title = "LEfSe", color = "l")
ggsave("Figures/Fig1B_mice_LEfSe.png")
```
...
ggsave("Figures/SupFig4A_mice_microbiomeMarker.png")
```
...
ggsave("Figures/SupFig4B_mice_venn_diagram.png")
```
