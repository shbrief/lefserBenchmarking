...
## From Galaxy
The LEfSe result from Galaxy is available [here](https://github.com/sdgamboa/lefse_comparison).
```{r}
...
## From Conda
The LEfSe result from Conda is available [here](https://github.com/sdgamboa/lefse_comparison).
```{r}
